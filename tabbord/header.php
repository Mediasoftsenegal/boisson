...
<body>
    ...
    <nav class="navbar navbar-expand navbar-white navbar-light bg-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
            <a href=../param/param.php" class="nav-link">Entreprise</a>
            </li>   
            <li class="nav-item d-none d-sm-inline-block">

                <a href="../param/user.php" class="nav-link">Utilisateurs</a>

            </li>

            <li class="nav-item d-none d-sm-inline-block">

                <a href="inventaire.php" class="nav-link">Inventaire</a>
