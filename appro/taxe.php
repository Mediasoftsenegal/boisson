...
<dd>Pour modifier cliquer sur l'icône dans la colonne action</dd>
    ...
    <div class="form-group">
        ...
        <input type="text" name="typetax" class="form-control is-warning" id="inputWarning" value="<?= $donne->type ?>">
        <? endforeach; ?>
        <? } else { ?>  
	...
	<?
             if (isset($_GET['id'])){?>
            <input type="text" name="valeurtax" class="form-control is-warning" id="inputWarning" value="<?= $donne->valeur ?>"> 
            <? } else { ?> 
